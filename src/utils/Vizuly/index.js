...
class VizulyWeightedTree extends Component {
  ...
  initialize() {
    ...
    _this.viz = vizuly.viz.weighted_tree(
    ...
    _this.theme = vizuly.theme
      .weighted_tree(_this.viz)
    ...
    _this.viz
      .data(_this.data) // Expects hierarchical array of objects.
        ...
        if (data[index].hasNextNode) {
          ...
          for (let k in data) {
            if (data[k]._id === nextid) {
              if (true) {
                //data[k].teachUnit.mCourseUnit.material.url
                let temp = [];
    ...
    return (
      <div id="editorContainerArea" className="editorContainerArea">
        <div
          ...
          style={{ height: '425px', width: '1065px' }}
        >
          ...
          <div id="editorBody" className="editorBody">
            <Row gutter={16} style={{ height: '100%' }}>
              ...
              <Col className="gutter-row" span={8}>
                <AidList adata={this.state.adata} />
              </Col>
            </Row>
            <Row gutter={16} style={{ height: '100%' }}>
              <Col className="gutter-row" span={8}>
              ...
              <List.Item>
                <List.Item.Meta
                  title={
                    <a
                      target="_blank"
                      href={`http://localhost:3001${item.material.url}`}
                    >
                      {item.title}
                    </a>
                  }
