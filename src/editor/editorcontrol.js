...
class EditorControl extends Component {
  ...
  addProject(newProjectData, callback) {
    this.request(
      '/addProject',
      { username: this.state.username, newProjectData: newProjectData },
      callback
    );
  }
  ...
  onSaveClick(e) {
    const _this = this;
    _this.request('/getProject', { username: _this.state.username }, function(
      res
    ) {
  ...
  onPublishClick(e) {
    ...
    this.request(
      '/publishCourse',
      { username: this.state.username, projectId: pid },
      data => {
  ...
  onDeleteClick(e) {
    ...
    _this.request(
      '/deleteProject',
      { username: _this.state.username, projectId: pid },
      function(e) {
        let pData = e;
        _this.setState({
          projectData: pData
      ...
      <div className="card-body">
        ...
        <div className="d-flex justify-content-between align-items-center buttonGroup">
          <div className="btn-group" data-pid={pData._id}>
            ...
            <button
              type="button"
              className="btn btn-sm btn-outline-secondary publishStatus"
...
const NoProject = ({}) => {
  ...
  return <div style={style}>请创建课程</div>;
};
