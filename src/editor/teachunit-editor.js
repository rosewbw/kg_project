...
class CourseEdit extends Component {
  constructor(props) {
    ...
    this.onMainCourseMaterialInfoChanged = this.onMainCourseMaterialInfoChanged.bind(
      this
    );
  }
          ...
          <Col className="gutter-row" span={24}>
            <Row gutter={2} style={{ marginBottom: '1px' }}>
              ...
              <Col className="gutter-row" span={8}>
                <AidList aCUnit={this.state.aCUnit} />
              </Col>
            </Row>
            <Row gutter={2}>
              <Col span={24}>
                    ...
                    >
                      <MainCourseInfo
                        ...
                        onMainCourseMaterialInfoChanged={
                          this.onMainCourseMaterialInfoChanged
                        }
                      />
                    </TabPane>
                    <TabPane
...
const BasicInfo = props => {
  ...
  for (let index in tUnit.keyword) {
    children.push(
      <Option key={tUnit.keyword[index]}>{tUnit.keyword[index]}</Option>
    );
  }
      ...
      <section id="basicInfo" className="basicInfo">
        <div onChange={basicInfoChange}>
          <InputGroup label="title" size="middle">
            <Col span={8}>
              <label>教学单元名称</label>
              <Input defaultValue={tUnit.title} id="title" />
            </Col>
          </InputGroup>
          <InputGroup label="description" size="middle">
            <Col span={8}>
              <label>教学单元描述信息</label>
              <Input defaultValue={tUnit.description} id="description" />
            </Col>
          </InputGroup>
...
const MainCourseInfo = props => {
  ...
  for (let index in tMaterialList) {
    if (tMaterialList[index]) {
      ...
      children[type].push(
        <Option key={tMaterialList[index]._id}>
          {tMaterialList[index].title}
        </Option>
      );
    }
  }
  return (
    <div>
      <Row>
          ...
          <section id="mainCourseBasicInfo" className="mainCourseBasicInfo">
            <div onChange={mCInfoChange}>
              <InputGroup label="title" size="middle">
                <Col>
                  <label>主课时名称</label>
                  <Input defaultValue={mCInfo.title} id="title" />
                </Col>
              </InputGroup>
        ...
        <Col className="gutter-row" span={8}>
          <section
            id="mainCourseMaterialInfo"
            className="mainCourseMaterialInfo"
          >
            <div>
              ...
              <Select
                ...
                style={{ width: 200 }}
                defaultValue={
                  mCInfo.material === undefined
                    ? '请选择素材'
                    : mCInfo.material.title
                }
                id="material"
    ...
    return (
      <div>
        <Row>
          ...
          <Col className="gutter-row" span={8}>
            <section
              id="aidCourseMaterialInfo"
              className="aidCourseMaterialInfo"
            >
              <div>
